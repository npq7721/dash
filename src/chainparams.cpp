...
static void printGenesisBlock(CBlock& genesis, Consensus::Params& consensus, uint32_t nGenesisTime, uint32_t nBits, uint32_t nVersion) {
    // This is used inorder to mine the genesis block. Once found, we can use the nonce and block hash found to create a valid genesis block
        ...
        std::cout << "fNegative, fOverflow " << fNegative  << ", " << fNegative << "\n";
        std::cout << "Test threshold: " << test.GetHex() << "\n\n";

        int genesisNonce = 0;
        genesis = CreateGenesisBlock(nGenesisTime, genesisNonce, nBits, nVersion, 50 * COIN);
        std::cout << "pow hash " << genesis.GetHash().GetHex() << std::endl;
        while (UintToArith256(genesis.GetHash()) > test)
	    {
        	std::cout << "pow hash " << genesis.GetHash().GetHex() << std::endl;
        	genesisNonce++;
		    if (genesisNonce % 4 == 0) printf("\rnonce %d", genesisNonce);
		    genesis = CreateGenesisBlock(nGenesisTime, genesisNonce, nBits, nVersion, 50 * COIN);
	    }
...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 50; // 00000000000076d8fcea02ec0963de4abfd01e771fec0863f960c2c64fe6f357
        consensus.BIP66Height = 50; // 00000000000b1fa2dfa312863570e13fae9ca7b5566cb27e55422620b469aefa
        ...
        consensus.nMinimumChainWork = uint256S("0"); // 1067570
        ...
        genesis = CreateGenesisBlock(1573064411, 617921, 0x1e0ffff0, 1, 50 * COIN);
      //  printGenesisBlock(genesis, consensus, 1573064411, 0x1e0ffff0, 1);
        consensus.hashGenesisBlock = genesis.GetHash();
        //printf("\ngenesis hash is %s\n", consensus.hashGenesisBlock.GetHex().c_str());
        assert(consensus.hashGenesisBlock == uint256S("0x00000a2ecb535b4bafbab52b8044a4f45aab43a7cf1bb6d3ed1ffb439fe29cfb"));
    ...
    //    vSeeds.push_back(CDNSSeedData("dashdot.io", "dnsseed.dashdot.io"));
      //  vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        ...
        vSporkAddresses = {"XnQmhcB92xSKZNCn2mPzUKzvYDZxxmukA2"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1573064411, // * UNIX timestamp of last known number of transactions (Block 1068571)
